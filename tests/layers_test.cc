...
TEST(LayerTest, RotaryEmbedding) {
...

  {
    ...
    layers::RotaryEmbeddings rotary_embeddings(0, true);
    StorageView x = input;
  ...
  {
    const StorageView expected({2, 4, 1, 4}, std::vector<float>{
        -0.7152905464172363, 0.8956361413002014, 0.6429175734519958, 0.9774127006530762,
        -0.39578449726104736, 0.5849034190177917, 0.2482617199420929, 0.8054997324943542,
        -1.2413266897201538, 0.1212884932756424, 0.46651098132133484, 0.596124529838562,
        -1.035674810409546, 0.5590142011642456, 0.48214325308799744, 0.4406721889972687,
        -0.6108748316764832, 0.5612415671348572, 0.694194495677948, 0.6388010382652283,
        -0.38219571113586426, 0.4246427118778229, 0.12161272019147873, 0.8403458595275879,
        -0.37009385228157043, 0.26545393466949463, -0.0535561665892601, 0.20471344888210297,
