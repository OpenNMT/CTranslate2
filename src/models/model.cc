...
#  ifdef CT2_WITH_FLASH_ATTN
        supports_flash_attention = true;  // native HIP kernels available
#  else
...
#  endif
      ...
      if (use_flash_attention && !supports_flash_attention) {
        ...
        throw std::invalid_argument(
            "FlashAttention is not available for this ROCm build. "
            "Rebuild CTranslate2 with -DWITH_HIP=ON -DWITH_FLASH_ATTN=ON.");
#else
