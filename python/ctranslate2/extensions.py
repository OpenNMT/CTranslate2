...
def register_extensions():
    ...
    setattr(
        GeneratorOnTheFly, "generate_iterable", generator_generate_iterable_on_the_fly
    )
    setattr(GeneratorOnTheFly, "score_iterable", generator_score_iterable_on_the_fly)
    setattr(GeneratorOnTheFly, "generate_tokens", generator_generate_tokens_on_the_fly)
    setattr(
        GeneratorOnTheFly,
        "async_generate_tokens",
        generator_async_generate_tokens_on_the_fly,
    )
...
def generator_generate_tokens_on_the_fly(
    generator: GeneratorOnTheFly,
    prompt: Union[List[str], List[List[str]]],
    max_batch_size: int = 0,
    batch_type: str = "examples",
    *,
...
def generator_generate_iterable_on_the_fly(
    generator: GeneratorOnTheFly,
    start_tokens: Iterable[List[str]],
    max_batch_size: int = 32,
    batch_type: str = "examples",
...
def generator_score_iterable_on_the_fly(
    generator: GeneratorOnTheFly,
    tokens: Iterable[List[str]],
    max_batch_size: int = 64,
    batch_type: str = "examples",
...
async def generator_async_generate_tokens_on_the_fly(
    generator: GeneratorOnTheFly,
    prompt: Union[List[str], List[List[str]]],
    max_batch_size: int = 0,
    batch_type: str = "examples",
